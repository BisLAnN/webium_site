    ...
    fetch('http://localhost:5000/auth/courses')
        ...
        .then(data => {
            ...
            data.forEach(function (course) {
                ...
                courseBlock += '<br></br><a href="developer_course_edit.html?id=' + course._id + '&name=' + encodeURIComponent(course.name) + '&description=' + encodeURIComponent(course.description) + '&sections=' + encodeURIComponent(JSON.stringify(course.sections)) +'&lessons=' + encodeURIComponent(JSON.stringify(course.lessons)) + '">просмотр</a>';
                courseBlock += '</div></div>';
